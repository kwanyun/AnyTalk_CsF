...
Usage:
    python -m scripts.data_preprocess --input_dir data/target/videos --step 1
    python -m scripts.data_preprocess --input_dir data/target/videos --step 2

Use --parallelism and --rank to partition preprocessing across multiple
processes.
"""
import argparse
import logging
